...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.special_expires'
        db.alter_column('catalog_item', 'special_expires', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Item.special_cost'
        db.alter_column('catalog_item', 'special_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Item.special_expires'
        db.alter_column('catalog_item', 'special_expires', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Item.special_cost'
        db.alter_column('catalog_item', 'special_cost', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
