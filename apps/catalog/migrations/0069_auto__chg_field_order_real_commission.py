...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.real_commission'
        db.alter_column('catalog_order', 'real_commission', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Order.real_commission'
        db.alter_column('catalog_order', 'real_commission', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'dengi_online': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'published_once': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'catalog.addon': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'addon_category_set'", 'to': "orm['catalog.AddonCategory']"}),
        ...
        'catalog.addoncategory': {
            ...
            'short_rate_title': ('django.db.models.fields.CharField', [], {'default': "'amount'", 'max_length': '16'}),
        ...
        'catalog.container': {
            'Meta': {'ordering': "['weight', 'id']", 'object_name': 'Container'},
        ...
        'catalog.item': {
            ...
            'mass': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'special_cost': ('django.db.models.fields.DecimalField', [], {'default': '100', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 17, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'catalog.mailcode': {
            'Meta': {'object_name': 'MailCode'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b878dbce-7ab8-4e18-876f-9cf02efe8262'", 'unique': 'True', 'max_length': '36'})
        },
        'catalog.offlineclient': {
            ...
            'subway': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True'})
        },
        'catalog.order': {
            ...
            'real_commission': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
