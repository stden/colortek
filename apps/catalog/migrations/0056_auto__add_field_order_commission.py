...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.commission'
        db.add_column('catalog_order', 'commission',
                      self.gf('django.db.models.fields.DecimalField')(default='0.1', max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.commission'
        db.delete_column('catalog_order', 'commission')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
