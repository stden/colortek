...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AtomMeanRating'
        db.create_table('catalog_atommeanrating', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('atom', self.gf('django.db.models.fields.related.ForeignKey')(related_name='atom_mean_rating_voteatom_set', to=orm['catalog.VoteAtom'])),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='atom_mean_rating_service_set', to=orm['catalog.Service'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='atom_mean_rating_user_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('catalog', ['AtomMeanRating'])


    def backwards(self, orm):
        # Deleting model 'AtomMeanRating'
        db.delete_table('catalog_atommeanrating')
