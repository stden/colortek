...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Addon.category'
        db.add_column('catalog_addon', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='addon_category_set', to=orm['catalog.AddonCategory']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Addon.category'
        db.delete_column('catalog_addon', 'category_id')
