...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Special.image'
        db.alter_column('catalog_special', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'Special.image'
        db.alter_column('catalog_special', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
