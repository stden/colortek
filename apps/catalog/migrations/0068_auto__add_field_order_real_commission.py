...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.real_commission'
        db.add_column('catalog_order', 'real_commission',
                      self.gf('django.db.models.fields.DecimalField')(default='0.1', max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.real_commission'
        db.delete_column('catalog_order', 'real_commission')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'catalog.mailcode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c3bdc995-8757-4549-a0e9-2712440eb3c5'", 'unique': 'True', 'max_length': '36'})
        },
        ...
        'catalog.order': {
            ...
            'real_commission': ('django.db.models.fields.DecimalField', [], {'default': "'0.1'", 'max_digits': '10', 'decimal_places': '2'}),
