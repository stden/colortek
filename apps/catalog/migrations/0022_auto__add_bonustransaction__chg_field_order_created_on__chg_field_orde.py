...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_bonustransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bonus_client_set', to=orm['auth.User'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='bonus_order_set', null=True, to=orm['catalog.Order'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('exchange_rate', self.gf('django.db.models.fields.DecimalField')(default=0.1, max_digits=5, decimal_places=2)),
            ('is_processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_discount', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('catalog', ['BonusTransaction'])


        # Changing field 'Order.created_on'
        db.alter_column('catalog_order', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Order.updated_on'
        db.alter_column('catalog_order', 'updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Deleting model 'BonusTransaction'
        db.delete_table('catalog_bonustransaction')


        # Changing field 'Order.created_on'
        db.alter_column('catalog_order', 'created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Order.updated_on'
        db.alter_column('catalog_order', 'updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
