...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OfflineClient.need_change'
        db.alter_column('catalog_offlineclient', 'need_change', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'OfflineClient.need_change'
        db.alter_column('catalog_offlineclient', 'need_change', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
