...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentTransaction.payment_id'
        db.add_column('catalog_paymenttransaction', 'payment_id',
                      self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentTransaction.payment_id'
        db.delete_column('catalog_paymenttransaction', 'payment_id')
