...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MailCode'
        db.create_table('catalog_mailcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='54728856-1d7b-4f3d-9e32-505d42b14e38', unique=True, max_length=36)),
        ))
        db.send_create_signal('catalog', ['MailCode'])


    def backwards(self, orm):
        # Deleting model 'MailCode'
        db.delete_table('catalog_mailcode')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 5, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'catalog.mailcode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'28f0bced-4508-44dd-b43f-9d83efaf5029'", 'unique': 'True', 'max_length': '36'})
        },
