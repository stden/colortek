...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_paymenttransaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_transaction_client_set', to=orm['auth.User'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_transaction_order_set', to=orm['catalog.Order'])),
            ('partner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payment_transaction_partner_set', to=orm['auth.User'])),
        ...
        db.send_create_signal('catalog', ['PaymentTransaction'])


    def backwards(self, orm):
        # Deleting model 'PaymentTransaction'
        db.delete_table('catalog_paymenttransaction')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 25, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
