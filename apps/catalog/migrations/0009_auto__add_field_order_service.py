...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.service'
        db.add_column('catalog_order', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_service_set', null=True, to=orm['catalog.Service']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.service'
        db.delete_column('catalog_order', 'service_id')
