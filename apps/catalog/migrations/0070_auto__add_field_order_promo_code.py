...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_order', 'promo_code',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catalog_order', 'promo_code')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 3, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
        ...
        'catalog.mailcode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1612c69f-3d16-47af-ab40-6fdc3d371d9e'", 'unique': 'True', 'max_length': '36'})
        },
