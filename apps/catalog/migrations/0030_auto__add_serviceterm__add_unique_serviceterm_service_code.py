...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServiceTerm'
        db.create_table('catalog_serviceterm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='service_term_set', to=orm['catalog.Service'])),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('term', self.gf('django.db.models.fields.CharField')(max_length=4096)),
        ))
        db.send_create_signal('catalog', ['ServiceTerm'])

        # Adding unique constraint on 'ServiceTerm', fields ['service', 'code']
        db.create_unique('catalog_serviceterm', ['service_id', 'code'])


    def backwards(self, orm):
        # Removing unique constraint on 'ServiceTerm', fields ['service', 'code']
        db.delete_unique('catalog_serviceterm', ['service_id', 'code'])

        # Deleting model 'ServiceTerm'
        db.delete_table('catalog_serviceterm')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 13, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
