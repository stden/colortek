...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalog_item', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))

        # Changing field 'Service.logo'
        db.alter_column('catalog_service', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=256, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Service.logo'
        db.alter_column('catalog_service', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
