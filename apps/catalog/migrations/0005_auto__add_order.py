...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_order', (
            ...
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_client_set', to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='in progress', max_length=16)),
