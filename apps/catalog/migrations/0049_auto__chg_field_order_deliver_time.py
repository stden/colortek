...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.deliver_time'
        db.alter_column('catalog_order', 'deliver_time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.deliver_time'
        db.alter_column('catalog_order', 'deliver_time', self.gf('django.db.models.fields.TimeField')())
