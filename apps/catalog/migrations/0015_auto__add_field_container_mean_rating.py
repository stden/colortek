...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Container.mean_rating'
        db.add_column('catalog_container', 'mean_rating',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Container.mean_rating'
        db.delete_column('catalog_container', 'mean_rating')
