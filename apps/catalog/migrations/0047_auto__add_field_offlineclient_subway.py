...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfflineClient.subway'
        db.add_column('catalog_offlineclient', 'subway',
                      self.gf('django.db.models.fields.CharField')(default=u'\xd0\x91\xd0\xb0\xd0\xbb\xd1\x82\xd0\xb8\xd0\xb9\xd1\x81\xd0\xba\xd0\xb0\xd1\x8f', max_length=512),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfflineClient.subway'
        db.delete_column('catalog_offlineclient', 'subway')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 4, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
