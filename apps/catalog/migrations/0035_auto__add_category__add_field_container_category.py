...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_category', (
            ...
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_service_set', to=orm['catalog.Service'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('catalog', ['Category'])

        # Adding field 'Container.category'
        db.add_column('catalog_container', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='container_category_set', null=True, to=orm['catalog.Category']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Container.category'
        db.delete_column('catalog_container', 'category_id')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 21, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
