...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.created_on'
        db.add_column('catalog_vote', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Vote.updated_on'
        db.add_column('catalog_vote', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.created_on'
        db.delete_column('catalog_vote', 'created_on')

        # Deleting field 'Vote.updated_on'
        db.delete_column('catalog_vote', 'updated_on')
