...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemCategory.short_rate_title'
        db.add_column('catalog_itemcategory', 'short_rate_title',
                      self.gf('django.db.models.fields.CharField')(default='amount', max_length=16),
                      keep_default=False)

        # Adding field 'AddonCategory.short_rate_title'
        db.add_column('catalog_addoncategory', 'short_rate_title',
                      self.gf('django.db.models.fields.CharField')(default='amount', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemCategory.short_rate_title'
        db.delete_column('catalog_itemcategory', 'short_rate_title')

        # Deleting field 'AddonCategory.short_rate_title'
        db.delete_column('catalog_addoncategory', 'short_rate_title')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
