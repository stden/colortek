...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalog_special', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='special_owner_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('catalog', ['Special'])


    def backwards(self, orm):
        # Deleting model 'Special'
        db.delete_table('catalog_special')
