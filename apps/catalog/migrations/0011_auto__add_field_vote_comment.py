...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_vote', 'comment',
                      self.gf('django.db.models.fields.CharField')(default=u'No comment provided', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.comment'
        db.delete_column('catalog_vote', 'comment')
