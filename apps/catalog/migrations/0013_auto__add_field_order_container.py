...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.container'
        db.add_column('catalog_order', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='order_container_set', to=orm['catalog.Container']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.container'
        db.delete_column('catalog_order', 'container_id')
