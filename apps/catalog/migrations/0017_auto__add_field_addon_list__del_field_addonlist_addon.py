...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Addon.list'
        db.add_column('catalog_addon', 'list',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='addon_list_set', to=orm['catalog.AddonList']),
                      keep_default=False)

        # Deleting field 'AddonList.addon'
        db.delete_column('catalog_addonlist', 'addon_id')


    def backwards(self, orm):
        # Deleting field 'Addon.list'
        db.delete_column('catalog_addon', 'list_id')

        # Adding field 'AddonList.addon'
        db.add_column('catalog_addonlist', 'addon',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.Addon']),
                      keep_default=False)
