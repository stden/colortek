...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalog_category', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_set', null=True, to=orm['catalog.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.parent'
        db.delete_column('catalog_category', 'parent_id')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 11, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
