...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.items'
        db.alter_column('catalog_vote', 'items_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalog.VoteItem']))

    def backwards(self, orm):

        # Changing field 'Vote.items'
        db.alter_column('catalog_vote', 'items_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['catalog.VoteItem']))
