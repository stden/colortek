...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.special_cost'
        db.add_column('catalog_item', 'special_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Adding field 'Item.special_expires'
        db.add_column('catalog_item', 'special_expires',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 11, 11, 0, 0)),
                      keep_default=False)

        # Adding field 'Item.is_special_active'
        db.add_column('catalog_item', 'is_special_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.special_cost'
        db.delete_column('catalog_item', 'special_cost')

        # Deleting field 'Item.special_expires'
        db.delete_column('catalog_item', 'special_expires')

        # Deleting field 'Item.is_special_active'
        db.delete_column('catalog_item', 'is_special_active')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 11, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        'catalog.order': {
