...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.deliver_date'
        db.add_column('catalog_order', 'deliver_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Order.deliver_time'
        db.add_column('catalog_order', 'deliver_time',
                      self.gf('django.db.models.fields.TimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.deliver_date'
        db.delete_column('catalog_order', 'deliver_date')

        # Deleting field 'Order.deliver_time'
        db.delete_column('catalog_order', 'deliver_time')
