...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderContainer.parent'
        db.add_column('catalog_ordercontainer', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parent_order_container_set', null=True, to=orm['catalog.OrderContainer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderContainer.parent'
        db.delete_column('catalog_ordercontainer', 'parent_id')
