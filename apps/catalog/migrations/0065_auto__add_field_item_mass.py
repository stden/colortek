...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.mass'
        db.add_column('catalog_item', 'mass',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.mass'
        db.delete_column('catalog_item', 'mass')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 24, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
