...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vote.items'
        db.delete_column('catalog_vote', 'items_id')

        # Adding field 'Vote.item'
        db.add_column('catalog_vote', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vote_voteitem_set', null=True, to=orm['catalog.VoteItem']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Vote.items'
        db.add_column('catalog_vote', 'items',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='vote_voteitem_set', null=True, to=orm['catalog.VoteItem'], blank=True),
                      keep_default=False)

        # Deleting field 'Vote.item'
        db.delete_column('catalog_vote', 'item_id')
