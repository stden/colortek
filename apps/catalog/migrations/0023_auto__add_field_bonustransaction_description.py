...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BonusTransaction.description'
        db.add_column('catalog_bonustransaction', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BonusTransaction.description'
        db.delete_column('catalog_bonustransaction', 'description')
