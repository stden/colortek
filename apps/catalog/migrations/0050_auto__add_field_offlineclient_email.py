...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OfflineClient.email'
        db.add_column('catalog_offlineclient', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OfflineClient.email'
        db.delete_column('catalog_offlineclient', 'email')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 6, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
