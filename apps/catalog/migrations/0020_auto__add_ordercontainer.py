...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderContainer'
        db.create_table('catalog_ordercontainer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ct_set_for_ordercontainer', to=orm['contenttypes.ContentType'])),
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='order_container_order_set', to=orm['catalog.Order'])),
        ))
        db.send_create_signal('catalog', ['OrderContainer'])

        # Removing M2M table for field items on 'Order'
        db.delete_table('catalog_order_items')

        # Removing M2M table for field addons on 'Order'
        db.delete_table('catalog_order_addons')


    def backwards(self, orm):
        # Deleting model 'OrderContainer'
        db.delete_table('catalog_ordercontainer')

        # Adding M2M table for field items on 'Order'
        db.create_table('catalog_order_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['catalog.order'], null=False)),
            ('item', models.ForeignKey(orm['catalog.item'], null=False))
        ))
        db.create_unique('catalog_order_items', ['order_id', 'item_id'])

        # Adding M2M table for field addons on 'Order'
        db.create_table('catalog_order_addons', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['catalog.order'], null=False)),
            ('addon', models.ForeignKey(orm['catalog.addon'], null=False))
        ))
        db.create_unique('catalog_order_addons', ['order_id', 'addon_id'])
