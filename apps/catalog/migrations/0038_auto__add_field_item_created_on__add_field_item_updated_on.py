...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.created_on'
        db.add_column('catalog_item', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Item.updated_on'
        db.add_column('catalog_item', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.created_on'
        db.delete_column('catalog_item', 'created_on')

        # Deleting field 'Item.updated_on'
        db.delete_column('catalog_item', 'updated_on')
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
