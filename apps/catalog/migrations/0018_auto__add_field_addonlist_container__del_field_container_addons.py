...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AddonList.container'
        db.add_column('catalog_addonlist', 'container',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='addon_list_container_set', to=orm['catalog.Container']),
                      keep_default=False)

        # Deleting field 'Container.addons'
        db.delete_column('catalog_container', 'addons_id')


    def backwards(self, orm):
        # Deleting field 'AddonList.container'
        db.delete_column('catalog_addonlist', 'container_id')

        # Adding field 'Container.addons'
        db.add_column('catalog_container', 'addons',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalog.AddonList'], null=True, blank=True),
                      keep_default=False)
