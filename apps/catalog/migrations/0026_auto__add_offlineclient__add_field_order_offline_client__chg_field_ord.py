...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OfflineClient'
        db.create_table('catalog_offlineclient', (
            ...
            ('phone2', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(related_name='offline_client_city', to=orm['geo.City'])),
            ('street', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('building', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('apartment', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('need_change', self.gf('django.db.models.fields.DecimalField')(default=100, max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal('catalog', ['OfflineClient'])

        # Adding field 'Order.offline_client'
        db.add_column('catalog_order', 'offline_client',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order_offline_client_set', null=True, to=orm['catalog.OfflineClient']),
                      keep_default=False)


        # Changing field 'Order.client'
        db.alter_column('catalog_order', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'OfflineClient'
        db.delete_table('catalog_offlineclient')

        # Deleting field 'Order.offline_client'
        db.delete_column('catalog_order', 'offline_client_id')


        # Changing field 'Order.client'
        db.alter_column('catalog_order', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))
    ...
    models = {
        ...
        'catalog.item': {
            ...
            'special_cost': ('django.db.models.fields.DecimalField', [], {'default': '100', 'max_digits': '10', 'decimal_places': '2'}),
            'special_expires': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 0, 0)'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
        'catalog.offlineclient': {
            ...
            'need_change': ('django.db.models.fields.DecimalField', [], {'default': '100', 'max_digits': '10', 'decimal_places': '2'}),
