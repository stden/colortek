...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PostType.service'
        db.add_column('blog_posttype', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='post_type_service_set', to=orm['catalog.Service']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PostType.service'
        db.delete_column('blog_posttype', 'service_id')
    ...
    models = {
        ...
        'blog.posttype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'service': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'post_type_service_set'", 'to': "orm['catalog.Service']"}),
