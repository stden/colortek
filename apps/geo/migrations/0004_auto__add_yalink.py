...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YaLink'
        db.create_table('geo_yalink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subway', self.gf('django.db.models.fields.related.ForeignKey')(related_name='yalink_subway_set', to=orm['geo.Subway'])),
            ('coords', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=512)),
        ))
        db.send_create_signal('geo', ['YaLink'])


    def backwards(self, orm):
        # Deleting model 'YaLink'
        db.delete_table('geo_yalink')
