...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GPos'
        db.create_table('geo_gpos', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lat', self.gf('django.db.models.fields.FloatField')(default=59.939038999999994)),
            ('lng', self.gf('django.db.models.fields.FloatField')(default=30.315784999999998)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='gpos_user_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('geo', ['GPos'])


    def backwards(self, orm):
        # Deleting model 'GPos'
        db.delete_table('geo_gpos')
