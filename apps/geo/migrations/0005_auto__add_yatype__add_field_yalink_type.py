...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'YaType'
        db.create_table('geo_yatype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default='rect', max_length=32)),
        ))
        db.send_create_signal('geo', ['YaType'])

        # Adding field 'YaLink.type'
        db.add_column('geo_yalink', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='yalink_type_set', to=orm['geo.YaType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'YaType'
        db.delete_table('geo_yatype')

        # Deleting field 'YaLink.type'
        db.delete_column('geo_yalink', 'type_id')
