...
from django_ipgeobase.models import IPGeoBase, IPGeoBaseManager
import caching.base
import socket
import struct

IPGeoBase.__bases__ = (caching.base.CachingMixin, models.Model)
IPGeoBaseManager.__bases__ = (caching.base.CachingManager, models.Manager)
