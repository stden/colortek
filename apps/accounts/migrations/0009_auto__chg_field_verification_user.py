...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Verification.user'
        db.alter_column('accounts_verification', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Verification.user'
        raise RuntimeError("Cannot reverse this migration. 'Verification.user' and its values cannot be restored.")
    ...
    models = {
        ...
        'accounts.delivercost': {
            'Meta': {'object_name': 'DeliverCost'},
            'cost': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max': ('django.db.models.fields.PositiveIntegerField', [], {'default': '5'}),
            'min': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'deliver_cost_user_set'", 'to': "orm['auth.User']"})
        },
        'accounts.invite': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_expired': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_verified': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'reciever': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'invite_reciever_user_set'", 'null': 'True', 'to': "orm['auth.User']"}),
        ...
        'accounts.verification': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'verification_user_set'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'auth.group': {
