...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TimeNDay.is_active'
        db.add_column('accounts_timenday', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TimeNDay.is_active'
        db.delete_column('accounts_timenday', 'is_active')
    ...
    models = {
        ...
        'accounts.invite': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
