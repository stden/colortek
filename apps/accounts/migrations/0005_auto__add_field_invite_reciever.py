...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invite.reciever'
        db.add_column('accounts_invite', 'reciever',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invite_reciever_user_set', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invite.reciever'
        db.delete_column('accounts_invite', 'reciever_id')
    ...
    models = {
        ...
        'accounts.invite': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 23, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
