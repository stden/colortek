...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_contactphone', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=21)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='phone_user_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('accounts', ['ContactPhone'])

        # Adding model 'ContactEmail'
        db.create_table('accounts_contactemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='email_user_set', to=orm['auth.User'])),
        ))
        db.send_create_signal('accounts', ['ContactEmail'])


    def backwards(self, orm):
        # Deleting model 'ContactPhone'
        db.delete_table('accounts_contactphone')

        # Deleting model 'ContactEmail'
        db.delete_table('accounts_contactemail')
