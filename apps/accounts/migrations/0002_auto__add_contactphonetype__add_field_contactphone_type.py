...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_contactphonetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
        ))
        db.send_create_signal('accounts', ['ContactPhoneType'])

        # Adding field 'ContactPhone.type'
        db.add_column('accounts_contactphone', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='phone_type_set', to=orm['accounts.ContactPhoneType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ContactPhoneType'
        db.delete_table('accounts_contactphonetype')

        # Deleting field 'ContactPhone.type'
        db.delete_column('accounts_contactphone', 'type_id')
