...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DeliverCost'
        db.create_table('accounts_delivercost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='deliver_cost_user_set', to=orm['auth.User'])),
            ('min', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('max', self.gf('django.db.models.fields.PositiveIntegerField')(default=5)),
            ('cost', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal('accounts', ['DeliverCost'])


    def backwards(self, orm):
        # Deleting model 'DeliverCost'
        db.delete_table('accounts_delivercost')
    ...
    models = {
        ...
        'accounts.invite': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 3, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
