...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_invite', (
            ...
            ('expire_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 10, 12, 0, 0))),
    ...
    models = {
        ...
        'accounts.invite': {
            ...
            'expire_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 12, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
