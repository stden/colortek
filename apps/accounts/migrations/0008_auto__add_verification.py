...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_verification', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='verification_user_set', to=orm['auth.User'])),
            ('is_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('accounts', ['Verification'])


    def backwards(self, orm):
        # Deleting model 'Verification'
        db.delete_table('accounts_verification')
    ...
    models = {
        ...
        'accounts.verification': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'verification_user_set'", 'to': "orm['auth.User']"})
        },
        'auth.group': {
